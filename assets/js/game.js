...
var Game = {
  ...
  preload: function() {
	...
	//charger les assets : (sons, spritesheets, images)
  ...
  update: function() {
	  ...
	  //Avancement de l'arrière plan avec le joueur
    
	  this.background.tilePosition.y += 2;

    if (this.activePlayer) {
        
    	//creation de flux de cartouches quand la fusée est en jeu
  ...
  startGame: function() {
    if (!this.activeGame) {
        //retirer les flèches quand le jeu commence .
  ...
  /**
   * creations des asteroides à emplacements aleatoires.
   */
  ...
  /**
   * creation d'ennemi à emplacement aléatoire.
   */
  spawnEnemy: function() {
  ...
  destroyEnemy: function(rocket, enemy) {
    ...
    //destruction de l'ennemi et de la cartouche.
